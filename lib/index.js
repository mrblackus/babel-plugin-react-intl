...
exports.default = function (_ref) {
    ...
    function createMessageDescriptor(propPaths) {
        var isTComp = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
    ...
    return {
        visitor: {
            ...
            JSXOpeningElement: function JSXOpeningElement(path, state) {
                ...
                var isTComp = path.node.name.name === COMPONENT_NAME;
            ...
            CallExpression: function CallExpression(path, state) {
                ...
                if (callee.node.name === 't') {
                    ...
                    var _path$get2 = (0, _slicedToArray3.default)(_path$get, 3);

                    var textPath = _path$get2[0];
                    var _ = _path$get2[1];
                    var cPath = _path$get2[2];

                    var text = getICUMessageValue(textPath);
                    var c = cPath ? getMessageDescriptorValue(cPath) : undefined;
...
var COMPONENT_NAME = 'T';
var MESSAGE_PROPERTY = 's';
var COMMENT_PROPERTY = 'c';